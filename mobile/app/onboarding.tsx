...
const SLIDES = [
  ...
  },
  {
    ...
    title: "Know a scam call\nbefore you answer",
    body: "Scam numbers get labeled right on your incoming call screen, and scam texts are filed to Junk before they ever buzz your phone.",
  },
  {
    id: "3",
    icon: "globe" as const,
    ...
    title: "Browse with a\nbodyguard",
    body: "The live Safe Browser checks every page and every link you tap in real time, and blocks dangerous sites before they load.",
  },
  {
    id: "4",
    icon: "star" as const,
